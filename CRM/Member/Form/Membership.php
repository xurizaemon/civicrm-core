  ...
  public function preProcess() {
    ...
    if ($this->_action & CRM_Core_Action::DELETE) {
      ...
      if ($this->_id && $contributionID && !CRM_Core_Permission::checkActionPermission('CiviContribute', $this->_action)) {
        CRM_Utils_System::permissionDenied(ts("This Membership is linked to a contribution. You must have 'delete in CiviContribute' permission in order to delete this record."));
      }
    }
